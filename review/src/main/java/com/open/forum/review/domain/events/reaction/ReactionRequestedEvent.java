...
public class ReactionRequestedEvent extends ReactionEvent {

    public ReactionRequestedEvent(Reaction reaction) {
        super(reaction.getPostId(),  Event.REACTION_REQUESTED, reaction.getUserId(), reaction);
    }
